...
- Комментарии в коде местами на русском — это норма для проекта, продолжайте
  ...
  там комментарии английские и короткие, а всё объяснение живёт в
  [`docs/clients/README.md`](docs/clients/README.md), который переводится вместе
  с сайтом. Правите пример — не возвращайте туда русские докстринги.
